...
{{< publication title="Dual Activation-Weight Sparsity: A Training-Free Framework for Efficient Large Language Model Compression" venue="ACL 2026" paperLink="" codeLink="" award="" project="" data-topic="Selected, Large Language Models" >}}
Luoyang Sun, Guangyan Li, Cheng Deng, Haifeng Zhang, Jian Zhao, Yongqiang Tang, Wensheng Zhang, Jun Wang
{{< /publication >}}

{{< publication title="Learning How to Remember: A Meta-Cognitive Management Method for Structured and Transferable Agent Memory" venue="ACL 2026" paperLink="" codeLink="" award="" project="" data-topic="Selected, Large Language Models" >}}
...
{{< publication title="LLM-SMAC: Solving Multi-Agent Decision-Making Tasks via LLM Decision Tree Code Generation" venue="AAMAS 2026" paperLink="https://openreview.net/attachment?id=92wBua64dP&name=pdf" codeLink="" award="" project="" data-topic="Selected, Large Language Models" >}}
Yue DENG, Weiyu Ma, Yuxin Fan, Ruyi Song, Yin Zhang, Haifeng Zhang, Jian Zhao
{{< /publication >}}

{{< publication title="Sim2Sea: Sim-to-Real Policy Transfer for Maritime Vessel Navigation in Congested Waters" venue="AAMAS 2026" paperLink="https://openreview.net/pdf?id=k4qIHgV6LW" codeLink="" award="" project="" data-topic="Selected, Large Language Models" >}}
Xinyu Cui, Xuanfa Jin, Xue Yan, Yongcheng Zeng, Luoyang Sun, Wei Siying, Ruizhi Zhang, Jian Zhao, Haifeng Zhang, Jun Wang
{{< /publication >}}

### Under Review

{{< publication title="STEMVerse: A Dual-Axis Diagnostic Framework for STEM Reasoning in Large Language Models" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
...
{{< publication title="Training LLMs to Self-Refine via Iterative Preference Optimization" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
...
{{< publication title="LLM-SMAC: Generating Interpretable Multi-Agent Policies through Programmatic Synthesis" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
Yue Deng, Weiyu Ma, Xiaoxia Cheng, ZiRui Wang, Yujing Hu, Tangjie Lv, Changjie Fan, Yin Zhang, Jian Zhao
{{< /publication >}}

{{< publication title="MAMBO-G: Magnitude-Aware Mitigation for Boosted Guidance" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
Shangwen Zhu, Qianyu Peng, Zhilei Shu, Yuting Hu, Han Zhang, Andy Zheng, Xinyu Cui, Jian Zhao, Ruili Feng, Fan Cheng
{{< /publication >}}

{{< publication title="Pisces: Video Generation over Events via Time Interval Encoding" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
...
{{< publication title="PromptManual: Beyond Black-Box Refinement with a Taxonomy-Driven Framework for Interpretable T2I Prompt Optimization" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
Xingxi Yin, Yan Gao, Yicheng Li, FengTao, Shuxin Zheng, Jian Zhao, Cong Huang, Yue Deng, Yin Zhang
{{< /publication >}}

{{< publication title="\pi-StepNFT: Wider Space Needs Finer Steps in Online RL for Flow-based VLAs" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
Siting Wang, Xiaofeng Wang, Minnan Pei, Xinyu Cui, Cheng Deng, Zheng Zhu, Jian Zhao, Guan Huang, Haifeng Zhang, Jun Wang
{{< /publication >}}

{{< publication title="ToMAgent: Enhancing ToM-based Decision-Making in Multi-Agent Interactions via Bi-Level Self-Play" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
Xuanfa Jin, Xinyu Cui, Zhijian Ma, Xue Yan, Jian Zhao, Haifeng Zhang, Jun Wang
{{< /publication >}}

{{< publication title="Information-Manifold Proximal Policy Optimization" venue="Preprint" paperLink="" codeLink="" award="" project="" data-topic="" >}}
